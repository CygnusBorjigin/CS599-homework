...
Proof.
  ...
  - intros m H. destruct m.
    + discriminate.
    + simpl in H. apply eq_implies_succ_equal. apply b in H. apply H.
Qed. 
(** [] *)
...
Proof.
  ...
  - intros m H. destruct m.
    ...
    + injection H as H1. 
      ...
      symmetry in H2.
      apply b in H2.
      apply eq_implies_succ_equal in H2.
      apply H2.
Qed.
...
Proof.
  ...
  induction l as [| n x y].
  - reflexivity.
  - simpl. destruct a.
    + discriminate.
    + intro H2. apply S_injective in H2. apply y in H2. apply H2.
Qed.
...
Proof.
  intros X Y l1.
  induction l1 as [| [x y] l' IH ].
  - intros l1 l2 H1. simpl in H1. injection H1 as H2 H3. 
    rewrite <- H2. rewrite <- H3. reflexivity.
  - intros l1' l2' H1. simpl in H1. destruct (split l') as [l1'' l2''] eqn:E.
    injection H1 as H2 H3. rewrite <- H2. rewrite <- H3.
    simpl. rewrite -> IH. reflexivity. reflexivity. Qed.
