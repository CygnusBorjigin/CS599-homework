...
Proof.
  intros n H1.
  inversion H1. inversion H0. apply H3.
Qed.
(** [] *)
...
Proof.
  intros n m H1 H2.
  induction H1 as [| n H3 IH].
  - simpl. apply H2.
  - simpl. remember (n + m) as k eqn:Hk.
    Search(ev). apply ev_SS in IH. apply IH.
Qed.
...
Proof.
  ...
  - apply (MUnionL s). apply H1.
  - apply (MUnionR re1). apply H1.
Qed.
...
Proof.
  ...
  induction ss as [| a b IH].
  - simpl. apply MStar0.
  - simpl. apply (MStarApp a (fold app b [])).
    + apply H1. simpl. left. reflexivity.
    + apply IH. intros s H2. apply H1. simpl. right. apply H2.
Qed.
(** [] *)
...
Proof.
  ...
  - split.
    ...
    + intros H1. apply H.
  - split.
    + intros H1. unfold not in H. apply H in H1. destruct H1.
...
Proof.
  intros n l H1.
  induction l as [| a b IH].
  + simpl. unfold not. intros H2. apply H2.
  + simpl. unfold not. intros H2. destruct H2 as [H2 | H2].
    - simpl in H1. destruct (eqbP n a) in H1.
      * discriminate H1.
      * rewrite H2 in H. unfold not in H. destruct H. reflexivity.
    - simpl in H1. destruct (eqbP n a) in H1.
      * discriminate H1.
      * simpl in H1. unfold not in IH. apply IH.
        ** apply H1.
        ** apply H2.
Qed.
(** [] *)
